...
6. Drag your new `Backup` folder from Finder into Terminal after the `ln -s` you just typed

7. Finish the command by typing `~/Library/Application\ Support/MobileSync/` and press [Return]
...
[^icloudbackup]: iCloud backups are great, but restoring from them takes _forever_.
